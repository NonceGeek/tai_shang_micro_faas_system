defmodule TaiShangMicroFaasSystemWeb.Router do
  @moduledoc """
    test.
  """
  alias Components.KVHandler.KVRouter
  use TaiShangMicroFaasSystemWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {TaiShangMicroFaasSystemWeb.LayoutView, :root}
  ...
  pipeline :browser_empty do
    ...
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {TaiShangMicroFaasSystemWeb.LayoutView, :empty}
    plug :protect_from_forgery
  ...
  scope "/", TaiShangMicroFaasSystemWeb do
    pipe_through :browser
  ...
  scope "/api/v1", TaiShangMicroFaasSystemWeb do
    pipe_through :api
  ...
  # scope "/api", TaiShangMicroFaasSystemWeb do
  #   pipe_through :api
  # end
  ...
  #   scope "/" do
  #     pipe_through :browser
  #     live_dashboard "/dashboard", metrics: TaiShangMicroFaasSystemWeb.Telemetry
  #   end
  # end
