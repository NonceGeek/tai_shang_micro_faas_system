defmodule Components.MirrorHandler do
    @moduledoc """
      Fetch articles from Mirror
    """

    alias Components.ArGraphQLInteractor
      ...
      {articles_handled, _} =
        Enum.map_reduce(articles, "", fn {article, original_digest}, acc ->
          if original_digest == acc do
            ...
            {Map.put(article, :original_digest, original_digest), original_digest}
          end
        end)
