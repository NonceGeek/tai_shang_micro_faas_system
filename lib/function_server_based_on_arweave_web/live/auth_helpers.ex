defmodule FunctionServerBasedOnArweaveWeb.AuthHelpers do
  ...
  def get_user(socket, session, config \\ [otp_app: :function_server_based_on_arweave])

  def get_user(socket, %{"function_server_based_on_arweave_auth" => signed_token}, config) do
