defmodule FunctionServerBasedOnArweaveWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug FunctionServerBasedOnArweaveWeb.EnsureRolePlug, [:user, :admin]

      plug FunctionServerBasedOnArweaveWeb.EnsureRolePlug, :admin

      plug FunctionServerBasedOnArweaveWeb.EnsureRolePlug, ~w(user admin)a
  """
