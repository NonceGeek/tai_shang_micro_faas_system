defmodule TaiShangMicroFaasSystem.DataToChain do

  alias TaiShangMicroFaasSystem.Coupon
  @node Application.fetch_env!(:tai_shang_micro_faas_system, :arweave_endpoint)
